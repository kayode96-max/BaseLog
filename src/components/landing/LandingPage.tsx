...
export function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
              BaseLog helps you document your Web3 journey. Add permanent,
              decentralized notes to your transactions and never forget the
              "why" behind a transfer again.
            </p>
      ...
      <section
        id="features"
        className="py-20 bg-white dark:bg-surface-dark border-y border-gray-100 dark:border-gray-800"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              We combine the permanence of blockchain with the usability of a
